...
constexpr std::array<RoleProfile, 26> profiles {{
    ...
    { TrackRole::LeadVocal,             0.00f, 1.00f, 1.35f, 0.20f, 0.00f, 120.0f, 180.0f, 0.60f, 4.0f, 0.50f, 4.0f, false, false, true,  false, true,  1.00f },
    { TrackRole::BackingVocal,          0.35f, 1.30f, 1.90f, 0.60f, 0.15f, 140.0f, 200.0f, 0.60f, 4.0f, 0.50f, 4.0f, false, false, true,  true,  false, 0.60f },
    ...
    { TrackRole::Percussion,            0.45f, 1.25f, 1.70f, 0.45f, 0.20f, 160.0f, 220.0f, 0.55f, 4.0f, 0.50f, 4.0f, true,  false, false, true,  false, 0.60f },
    { TrackRole::RhythmGuitarSingle,    0.35f, 1.20f, 1.85f, 0.45f, 0.05f, 140.0f, 180.0f, 0.55f, 4.0f, 0.50f, 4.0f, false, false, true,  false, false, 0.60f },
    { TrackRole::RhythmGuitarPairLeft, -0.85f, 1.00f, 1.35f, 0.45f, 0.00f, 140.0f, 180.0f, 0.55f, 4.0f, 0.50f, 4.0f, false, false, false, false, false, 0.60f },
    { TrackRole::RhythmGuitarPairRight, 0.85f, 1.00f, 1.35f, 0.45f, 0.00f, 140.0f, 180.0f, 0.55f, 4.0f, 0.50f, 4.0f, false, false, false, false, false, 0.60f },
    { TrackRole::LeadGuitar,            0.00f, 1.10f, 1.70f, 0.30f, 0.05f, 140.0f, 180.0f, 0.55f, 4.0f, 0.50f, 4.0f, false, false, true,  false, true,  0.80f },
    { TrackRole::Pad,                   0.00f, 1.55f, 2.10f, 0.80f, 0.20f, 180.0f, 220.0f, 0.40f, 3.0f, 0.40f, 3.0f, false, false, true,  true,  false, 0.25f },
    ...
    { TrackRole::FX,                    0.00f, 1.65f, 2.25f, 0.70f, 0.35f, 180.0f, 220.0f, 0.35f, 3.0f, 0.30f, 3.0f, false, false, true,  true,  false, 0.25f },
    { TrackRole::Atmosphere,            0.00f, 1.65f, 2.25f, 0.85f, 0.20f, 200.0f, 250.0f, 0.25f, 2.5f, 0.30f, 2.5f, false, false, true,  true,  false, 0.25f },
    { TrackRole::SunoVocal,             0.00f, 1.00f, 1.35f, 0.30f, 0.00f, 120.0f, 180.0f, 0.55f, 3.0f, 0.50f, 3.5f, false, false, true,  false, true,  1.00f },
    { TrackRole::SunoInstrumental,      0.00f, 1.20f, 1.70f, 0.45f, 0.05f, 160.0f, 220.0f, 0.55f, 3.0f, 0.50f, 3.5f, false, true,  false, false, false, 0.60f },
    ...
    { TrackRole::SunoGuitar,            0.00f, 1.20f, 1.85f, 0.45f, 0.05f, 140.0f, 180.0f, 0.55f, 3.5f, 0.50f, 3.5f, false, false, true,  false, false, 0.60f },
    { TrackRole::SunoSynthPad,          0.00f, 1.55f, 2.05f, 0.70f, 0.15f, 180.0f, 220.0f, 0.40f, 3.0f, 0.40f, 3.0f, false, false, true,  true,  false, 0.40f },
    { TrackRole::SunoPercussion,        0.40f, 1.20f, 1.65f, 0.45f, 0.15f, 160.0f, 220.0f, 0.55f, 3.5f, 0.50f, 3.5f, true,  false, false, true,  false, 0.60f },
    { TrackRole::SunoFX,                0.00f, 1.60f, 2.20f, 0.70f, 0.25f, 180.0f, 240.0f, 0.35f, 3.0f, 0.30f, 3.0f, false, false, true,  true,  false, 0.25f }
}};
...
float RolePresetEngine::mapWidthUserToAmount(float width) noexcept
{
    ...
    if (width <= 0.70f)
        return juce::jmap(width, 0.30f, 0.70f, 1.0f, 1.55f);

    return juce::jmap(width, 0.70f, 1.0f, 1.55f, 2.25f);
}
...
SafetyLimits RolePresetEngine::getSafetyLimits(SafetyMode safety) noexcept
{
    switch (safety)
    {
        case SafetyMode::MonoSafe:       return { 1.15f,  0.25f };
        case SafetyMode::ModernWide:     return { 2.05f,  0.00f };
        case SafetyMode::HeadphonesWide: return { 2.25f, -0.10f };
        case SafetyMode::Natural:
        default:                         return { 1.65f,  0.10f };
    }
}
